...
export default function FloatingInput({
  ...
  return (
    <div className="relative w-[560px] h-[50px]">
        {/* Input */}
        <input
        type={type}
        value={value}
        ...
        className={clsx(
            'w-full h-[50px] rounded-lg border-2 px-4 outline-none text-[16px] leading-[22.4px] text-black placeholder:text-gray-400',
